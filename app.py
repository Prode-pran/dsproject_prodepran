...
if page == "Homepage":
    ...
    st.image("https://freerangestock.com/sample/145397/artificial-intelligence-background--abstract-ai-background-with.jpg", caption="Your Amazing Banner Image", use_column_width=True)
    st.write("""
